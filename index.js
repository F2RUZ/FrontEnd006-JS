...
// const arr = ["Jalol", "Yusuf", "Shoxrux", "Sunnat"];

// const first = arr[0];
// const second = arr[1];
// const thirds = arr[2];

// const [first, second, ...thirds] = arr;
...
// });
// const numbers = [133, 22, 3343, 45454, 5, 62, 84, 7666];

// const arr = ["Yusuf", "Jaloliddin", "Elyor", "Abdulaziz"];

// const result = numbers.sort((b, a) => {
//   return a - b;
// });
...
// todos.forEach({task , id , describe ,date } =>
